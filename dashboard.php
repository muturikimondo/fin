...
<main class="container py-5">
    ...
    <!-- Logout Button (light background + red icon + confirmation) -->
    <div class="row mb-4">
        <div class="col-12 text-md-end">
            <a href="auth/logout.php"
               class="btn btn-lg w-100 w-md-auto hover-effect"
               style="background-color: var(--light-color);"
               title="Logout"
               onclick="return confirm('Are you sure you want to log out?');">
                <i class="bi bi-power text-danger" style="font-size: 1.5rem;"></i> Logout
            </a>
        </div>
    </div>
